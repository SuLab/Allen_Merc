angular.module("mercatorApp",['plotly','ui.select','ngSanitize','olsAutocompleteMod','ui.bootstrap','ngTable'])
    ...
    .controller('plotController',['$http', '$scope', '$log', 'plotData', '$q', '$window','NgTableParams', 'mannWhitney', function($http, $scope, $log, plotData, $q, $window,NgTableParams,mannWhitney){
	var vm = this;
