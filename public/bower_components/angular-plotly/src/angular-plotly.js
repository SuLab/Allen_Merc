            ...
            return {
                ...
                link: function(scope, element) {
                    ...
                    function onUpdate() {
                        ...
                        Plotly.redraw(graph);
			// Plotly.restyle(graph,scope.plotlyData,scope.plotlyLayout);
			// Plotly.deleteTraces(graph);
			// Plotly.addTraces(graph,scope.plotlyData);
			// Plotly.relayout(graph,scope.plotlyLayout);
                        Plotly.Plots.resize(graph,scope.plotlyData,scope.plotlyLayout);
                    }
